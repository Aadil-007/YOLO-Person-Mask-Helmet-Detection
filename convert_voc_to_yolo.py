...
# Define paths (updated to match your folder structure)
dataset_dir = '.'  # Root project directory
...
# Class names (from Kaggle dataset)
...
print("Conversion complete. Check 'yolo_dataset' folder.")